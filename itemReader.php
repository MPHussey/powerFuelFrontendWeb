            ...
            <div class="col-xl-6">
                <div class="card shadow-lg o-hidden border-0 my-5">
                    <div class="card-body p-0">
                        <div class="row">
                            <div style="height:750px" class="col -lg-5">
                                <div  class="row justify-content-center pt-4">
                                    <img class="img-fluid px-2" src="Resources/icons/logo.PNG" alt="brand">
                                </div>
                                <hr>
                               <div class="row-element">
                                ...
                                <div id="form-frame" class="px-5 pb-5 pt-4">
                                    <form class="user" action="itemread-backend.php" method="post">
                                        ...
                                        <input type="hidden" name="empid" id="empid" value="<?php echo $session ?>">
                                        <button name="btn-submit" id="btn-submit" class="btn btn-block btn-user btn-cart" type="submit">Add to cart</button>
                                        <hr>
                                        

                                         
                                    </form>
                                    <div class="text-center"><a  href="itemCart.php">View Cart</a></div>
